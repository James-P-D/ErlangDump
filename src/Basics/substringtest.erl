% c("substringtest.erl").
% substringtest:stuff([N, "abc", "abcdef"]).      % Returns true, N = 0
% substringtest:stuff([N, "abc", "xyzabcdef"]).   % Returns true, N = 3
% substringtest:stuff([N, "abc", "xyzabcdef"]).   % Returns false, N = -1
